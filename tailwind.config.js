    ...
    extend: {
      ...
      colors: {
        ...
        wood: {
          ...
          'amber-light': '#dbb978',
          'amber-dark': '#a8834a',
          // Semantic backgrounds (deep wenge) — used as bg-wood-bg / -elevated / -card
          bg: {
            DEFAULT: '#1a1614',
            elevated: '#221e1a',
            card: '#2a2520',
          },
          // Semantic text — used as text-wood-text-primary / -secondary / -muted
          text: {
            primary: '#f5efe6',
            secondary: '#bdb3a7',
            muted: '#8a7f74',
      ...
      backgroundImage: {
        ...
        'gradient-radial-dark':
          'radial-gradient(ellipse at center, rgba(201, 164, 92, 0.08) 0%, transparent 70%)',
        // Legacy
        linen:
      ...
      boxShadow: {
        ...
        'wood-glow-lg':
          '0 0 40px rgba(201, 164, 92, 0.5), 0 0 60px rgba(201, 164, 92, 0.2)',
        ...
        'neon-amber':
          '0 0 25px rgba(201, 164, 92, 0.5), 0 0 50px rgba(201, 164, 92, 0.2)',
        'neon-amber-lg':
          '0 0 35px rgba(201, 164, 92, 0.7), 0 0 60px rgba(201, 164, 92, 0.3)',
      },
      animation: {
      ...
      keyframes: {
        ...
        pulseGlow: {
          ...
          '50%': {
            boxShadow:
              '0 0 40px rgba(201, 164, 92, 0.6), 0 0 60px rgba(201, 164, 92, 0.3)',
          },
        },
        shimmer: {
