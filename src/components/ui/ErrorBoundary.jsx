        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-[#1c1917] text-white p-6 text-center">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl max-w-sm w-full shadow-2xl">
            ...
            <button
              ...
              className="w-full bg-amber-600 text-white py-4 rounded-xl font-bold flex items-center justify-center gap-2 active:scale-95 transition-all hover:bg-amber-500 border-2 border-amber-500 animate-neon-pulse"
            >
              <RefreshCw size={18} />
              Перезагрузить
            </button>
