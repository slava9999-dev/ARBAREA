...
const ProductCarousel = ({ images }) => {
  ...
  // Guards the lightbox tap against a just-finished drag on the photo.
  ...
  return (
    <>
      ...
      {/* Lightbox Modal — portal + native <dialog> so it escapes the
          backdrop-filter containing block of <main> and stays viewport-sized. */}
      {isLightboxOpen && (
