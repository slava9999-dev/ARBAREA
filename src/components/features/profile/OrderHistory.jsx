...
const OrderHistory = () => {
    ...
    if (loading) {
        return (
            <div className="bg-white dark:bg-stone-800 p-5 rounded-3xl shadow-sm border border-stone-100 dark:border-stone-700 mb-8">
                <p className="text-center text-stone-500 dark:text-stone-400 text-sm">Загрузка...</p>
            </div>
        );
    }
        ...
        return (
            <div className="bg-white dark:bg-stone-800 p-5 rounded-3xl shadow-sm border border-stone-100 dark:border-stone-700 mb-8">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-serif font-bold text-stone-800 dark:text-stone-100">История заказов</h3>
                </div>
                <p className="text-center text-stone-500 dark:text-stone-400 text-sm">
                    ...
                    >
                        ...
                        <div className="space-y-1 mb-2">
                            {order.items?.map((item, index) => (
                                <p key={index} className="text-xs text-stone-600 dark:text-stone-400">
                        ...
                        <div className="flex justify-between items-center pt-2 border-t border-stone-200 dark:border-stone-700">
                            <span className="text-xs text-stone-500 dark:text-stone-400">Итого:</span>
