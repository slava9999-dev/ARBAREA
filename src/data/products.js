export const PRODUCTS = [
  ...
  // Панно
  {
    ...
    hasOptions: true,
    description:
      'Эффектное деревянное панно с изображением горного пейзажа. Ручная работа, натуральный дуб. Создаёт атмосферу спокойствия и единения с природой.',
  },
  {
    id: 2,
    name: 'Панно "Лес"',
    ...
    price: 7500,
    image:
      'https://images.unsplash.com/photo-1579856475740-38c62bc14bd8?q=80&w=1000&auto=format&fit=crop',
    rating: 4.8,
    hasOptions: true,
    description:
      'Минималистичное панно с абстрактным изображением леса. Идеально для современных интерьеров. Покрыто экологичным маслом.',
  },
  {
    id: 3,
    name: 'Панно "Волны"',
    ...
    hasOptions: true,
    description:
      'Элегантное объёмное панно с рельефом морских волн. Игра света и тени создаёт живой эффект. Премиум качество.',
  },
  ...
  // Для кухни (остальные)
  {
    ...
    price: 4200,
    image:
      'https://images.unsplash.com/photo-1584990347449-39b4aa37f955?q=80&w=1000&auto=format&fit=crop',
    rating: 4.9,
    hasOptions: false,
    description:
      'Магнитная подставка из дуба с мощными неодимовыми магнитами. Надёжно удерживает ножи любого веса. Стильный акцент на кухне.',
  },
  {
    id: 6,
    ...
    price: 5500,
    image:
      'https://images.unsplash.com/photo-1572297794533-5eec6b40ae11?q=80&w=1000&auto=format&fit=crop',
    rating: 4.8,
    hasOptions: true,
    description:
      'Стильная настенная полка для хранения вина. Вмещает до 6 бутылок. Металлические крепления в комплекте.',
  },
  {
    id: 7,
    ...
    price: 2800,
    image:
      'https://images.unsplash.com/photo-1604421017753-7a9f03fef9ef?q=80&w=1000&auto=format&fit=crop',
    rating: 5.0,
    hasOptions: false,
    description:
      'Торцевая доска из дуба премиум класса. Не тупит ножи, выдерживает интенсивное использование. Пропитана минеральным маслом.',
  },
  ...
  },
  {
    ...
    hasOptions: true,
    description:
      'Многоуровневая полка из влагостойкого дуба. Идеальна для хранения косметики и полотенец. Специальная обработка против плесени.',
  },
  {
    id: 10,
    ...
    hasOptions: true,
    description:
      'Компактный держатель в минималистичном стиле. Дерево и металл гармонично сочетаются. Простая установка.',
  },
  {
    id: 11,
    ...
    price: 3800,
    image:
      'https://images.unsplash.com/photo-1600566752734-a4e0c6c4d088?q=80&w=1000&auto=format&fit=crop',
    rating: 4.9,
    hasOptions: true,
    description:
      'Настенная вешалка с 4 крючками из натурального дерева. Выдерживает до 20 кг. Стильное дополнение ванной комнаты.',
  },
  ...
  // Свет
  {
    ...
    hasOptions: false,
    description:
      'Дизайнерский светильник кубической формы. Рассеянный тёплый свет создаёт уютную атмосферу. LED лампа в комплекте.',
  },
  {
    id: 13,
    ...
    price: 12500,
    image:
      'https://images.unsplash.com/photo-1550664973-880c57c6cca0?q=80&w=1000&auto=format&fit=crop',
    rating: 4.9,
    hasOptions: false,
    description:
      'Массивная потолочная люстра из состаренного дуба. Настоящее произведение искусства. До 5 ламп E27.',
  },
  {
    id: 14,
    name: 'Бра "Лофт"',
    ...
    hasOptions: true,
    description:
      'Настенное бра в индустриальном стиле. Комбинация дерева и металла. Регулируемый угол наклона плафона.',
  },
  {
    id: 15,
    ...
    price: 9200,
    image:
      'https://images.unsplash.com/photo-1565705990481-cc46c3d861e7?q=80&w=1000&auto=format&fit=crop',
    rating: 4.7,
    hasOptions: false,
    description:
      'Элегантный торшер с основанием из массива ясеня. Тканевый абажур ручной работы. Высота 150 см.',
  },
  {
